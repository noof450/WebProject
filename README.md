...
# Project Idea
In this ptoject we will made a <b>ChatRoom</b>, which is a web-based platform that enables users to communicate with each other in real-time.
The ChatRoom can be used for various purposes, such as socializing, networking, or collaborating.

# Project Description

<b> Our ChatRoom have many basic features which are: </b>
